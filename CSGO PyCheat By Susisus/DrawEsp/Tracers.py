...
window = glfw.create_window(2560, 1440, 'tracers', None , None)
...
def main():
    while True:
        ...
        for x in range(32):
            ...
            gl.glVertex2f(screenSize.x / 2, 100)
            gl.glVertex2f(Entity_2d_Position.x, (screenSize.y -  Entity_2d_Position.y) - 30)         
