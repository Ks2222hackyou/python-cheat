...
window = glfw.create_window(2560, 1440, 'Hp', None , None)
glfw.make_context_current(window)
gl.glOrtho(0, screenSize.x, 0, screenSize.y, -1, 1)
 
handle = win32gui.FindWindow(0, 'Hp')
...
def main():
    while True:
        ...
        for x in range(32):
            ...
            color3 = (100,150,255)
            gl.glColor3b(*color3)        
            gl.glVertex2f(Entity_2d_Position.x - 30, (screenSize.y -  Entity_2d_Position.y)- 30)
            gl.glVertex2f(Entity_2d_Position.x - 30, (screenSize.y -  Entity_2d_Position.y)+ 30)
            ...
            gl.glColor3b(*color2)
            gl.glVertex2f(Entity_2d_Position.x - 30, (screenSize.y -  Entity_2d_Position.y)- 30)
            gl.glVertex2f(Entity_2d_Position.x - 30, (screenSize.y -  Entity_2d_Position.y)+ (Entity_Health * 30))
